...
## [pixL-master] - 2025-05-17
- french translations for AdvancedControllersConf, AdvancedEmulatorMain, CemuSettings, SupermodelSettings, Pcsx2Settings, XemuSettings, CitraSettings, DolphinSettings, GamesMain, InterfaceMain, Model2emuSettings, ParametersList, QuaGzipFile/quaziodevice, Rpcs3Settings, SystemsEmulatorConfiguration and VideoSettings
- clean all "vanished" ones in french file
- update all other languages (but without translations) and just to have last version generated by Qt Creator Linguist lupdate command
